...
<section class="p-3" style="margin-left:85px;">
    <div class="text-end mb-2 conteudo-esconder-pdf">
        <bbutton class="btn btn-success newUser " data-bs-toggle="modal" data-bs-target="#userForm">
...
<style>
    ...
    body {
        margin-left: 120px; /* Move a página 30px para a direita */
    }
</style>
            ...
            <table class="table table-striped table-hover mt-3 text-center table-bordered">
                ...
                <?php
                    if (!empty($aulas)) {
                        ...
                        echo "<tr><td colspan='6'>Nenhuma aula cadastrada ainda</td></tr>";
                    }
                ?>
                </tbody>
            </table>
